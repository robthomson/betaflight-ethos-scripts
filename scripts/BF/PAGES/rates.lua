...
if bf.apiVersion >= 1.16 and bf.apiVersion <= 1.44 then
...
return {
    ...
    updateRatesType = function(self, applyDefaults)
        local ratesTable = assert(bf.loadScript("RATETABLES/"..self.getRatesType(self)..".lua"))()
