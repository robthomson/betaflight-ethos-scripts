...
if bf.apiVersion >= 1.16 and bf.apiVersion <= 1.43 then
...
if bf.apiVersion >= 1.40 and bf.apiVersion <= 1.41 then
...
if bf.apiVersion >= 1.40 then
    ...
    elseif bf.apiVersion >= 1.42 then
...
if bf.apiVersion >= 1.36 then
    ...
    if bf.apiVersion >= 1.40 and bf.apiVersion <= 1.44 then
    ...
    elseif bf.apiVersion >= 1.44 then
...
return {
    ...
    preSave = function(self)
        self.reboot = self.values[50] ~= self.dynamicIdle and bf.apiVersion <= 1.43
        return self.values
    end,
}
